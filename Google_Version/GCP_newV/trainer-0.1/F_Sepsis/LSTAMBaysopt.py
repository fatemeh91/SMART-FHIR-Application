...
from ValueItr_LSTAM_v3_Bays import Main_Loop
import numpy as np
...
def main():
    ...
    filepath = 'gs://emory-sepsis-data2/Result_4000patients.z'
    filename = 'Result_4000patients_5_epoch_Bays.z'
    ...
    dump(forest_res,os.path.join('./',filename))
    ...
    call(["gsutil","-m","cp",'./Result_4000patients_5_epoch_Bays.z',filepath])

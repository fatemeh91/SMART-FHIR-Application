...
class main_network():
    ...
    def __init__(self,R_CT,St,Stp1,time_stamp,n_featurs=113,n_h=[113,65,1],n_layers=3,n_out=1,gamma = 0.2,alpha=0.1,learning_rate=0.001):
        self.R = R_CT
        self.St=St
        self.Stp1=Stp1
...
#         return out_layer
    ...
    def TD_Zero(self):
        ...
        opt=tf.train.RMSPropOptimizer(self.learning_rate).minimize(total_error)
            
        
        #total_error = tf.gradients(TD_error[-1],self.weight_init[0])

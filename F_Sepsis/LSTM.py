...
class LSTM_Bolck():
    def __init__(self,Rewards,St,Stp1,cellm1,ym1,Nlast_Ts,AccLoss,Batch_Loss,n_L_B=1,n_features=159,learning_rate=0.0001):
        self.St=St
        self.R=Rewards
        self.Stp1=Stp1
        self.cellm1=cellm1
    ...
    def predict(self):
        ...
        NV=block_output(self.St,CV,new_cell)[0]
        
        return [new_cell,CV,NV]
        
    @define_scope
    # i compute the abs of error is it right????
    def TD_Zero(self):

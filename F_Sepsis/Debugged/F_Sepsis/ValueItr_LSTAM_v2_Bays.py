...
#            
            ...
            filename='./per1_crossfold_te_1_rewards_epoch_30_job_training_error_fold'+str(fold_index)+'.csv'
            pd.DataFrame.to_csv(df1,filename)
            filepath='gs://emory-sepsis-data2/per1_corossfold_te_1_rewards_epoch_30_job_training_error_fold'+str(fold_index)+'.csv'
            ...
            #filepath='gs://emory-sepsis-data2/validation_value.csv'
            #call(["gsutil","-m","cp",'./validation_value.csv',filepath])
